...
export type Order = { id:string; email:string; customerName?:string; shippingAddress?:string; total:number; status:string; items:Array<{title:string;quantity:number;price:number}> };
